...
import com.example.aplikasimonitoringdanevaluasi.databinding.FragmentCourseStudentBinding
import com.example.aplikasimonitoringdanevaluasi.ui.admin.course.CourseAdminFragment
import com.example.aplikasimonitoringdanevaluasi.ui.admin.course.CourseAdminPagerAdapter
...
class CourseStudentFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val sectionsPagerAdapter = CourseStudentPagerAdapter(requireActivity() as AppCompatActivity)
